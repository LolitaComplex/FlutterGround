  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FractionallySizedBox(
        ...
        child: Column(
          children: [
            MaterialButton(child: Text("Obx刷新") ,onPressed: () => Navigator.push(context,
              MaterialPageRoute(builder: (context) => GetXObxPage()))),
            MaterialButton(child: Text("GetX Controller 刷新") ,onPressed: () => Navigator.push(context,
                MaterialPageRoute(builder: (context) => GetXControllerPage()))),
            MaterialButton(child: Text("GetX Builder 刷新") ,onPressed: () => Navigator.push(context,
                MaterialPageRoute(builder: (context) => GetXBuilderRefreshPage()))),
            MaterialButton(child: Text("GetX Worker") ,onPressed: () => Navigator.push(context,
